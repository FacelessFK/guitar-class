...
/**
 * ⚠️ «از ۸۵۰ هزار تومان» و «قیمت ویژه» متنِ تأییدشده‌ی پروتوتایپ‌اند و
 * از داده نمی‌آیند. پیش از انتشار باید با قیمت واقعی استادها بخوانند —
 * صفحه‌ی ساز در همان دیزاین «از ۶۵۰ هزار تومان» می‌گوید و این دو با هم
 * نمی‌خوانند.
 */
const SESSION_TYPES = [
  {
